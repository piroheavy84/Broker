class ItalianGeography {
  static const Map<String, List<String>> provinceByRegion = {
    ...
    'Sardegna': ['Sassari', 'Gallura Nord-Est Sardegna', 'Nuoro', 'Oristano', 'Ogliastra', 'Medio Campidano', 'Cagliari', 'Sulcis Iglesiente'],
  };

  static const Map<String, String> areaByRegion = {
    'Piemonte': 'Nord',
  ...
  static List<String> get regions => provinceByRegion.keys.toList();
  static List<String> provinces(String region) => provinceByRegion[region] ?? const [];
}